 ...
 <div class="registration-container">
        ...
        <form id="registrationForm" onsubmit="return handleRegister()">
            ...
            <div class="input-group">
                ...
                <input type="password" id="password" v-model="password1" placeholder="输入密码" required>
            </div>
            <div class="input-group">
                <label for="confirm-password">确认密码</label>
                <input type="password" id="confirm-password" v-model="password2" placeholder="确认密码" required>
            </div>
