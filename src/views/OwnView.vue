  ...
  <div class="bigbox">
    <div class="line-content">
      ...
      <div class="quart">
        ...
        <textarea name="" id="biotext" cols="70" rows="7"  v-model="bio" :disabled ="!isEditing"></textarea>
      </div>
  ...
  <div class="modal-mask" v-show="isWhite">
    <div class="content" v-show="isShow">
      <h3>个人信息</h3>
        ...
        <button class="cancelMessage" @click="cancleButton">cancel</button><button class="okMessage" @click="okButton">OK</button>
    </div>
  </div>
...
.editMessage,.saveMessage,.cancelMessage,.okMessage{
    height: 30px;
